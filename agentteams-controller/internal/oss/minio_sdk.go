...
// Select via AGENTTEAMS_STORAGE_DRIVER=sdk (default); AGENTTEAMS_STORAGE_DRIVER=mc
...
// AGENTTEAMS_STORAGE_CONNECT_TIMEOUT_SECONDS (see storage_env.go). Connection
...
// wrapper's backoff. Configurable via AGENTTEAMS_STORAGE_SDK_MAX_RETRIES.
...
// form (e.g. "agentteams/agentteams-storage"); the alias segment is stripped and the
...
// (AGENTTEAMS_storage_op_duration_seconds / AGENTTEAMS_storage_op_errors_total),
