...
func TestDockerCreateResolvesImageFromRuntime(t *testing.T) {
	cases := []struct {
		...
		{"explicit_cimicode_uses_cimicode_image", RuntimeCimicode, "", "agentteams/cimicode-worker:latest"},
		...
		{"empty_runtime_with_cimicode_fallback_uses_cimicode_image", "", RuntimeCimicode, "agentteams/cimicode-worker:latest"},
