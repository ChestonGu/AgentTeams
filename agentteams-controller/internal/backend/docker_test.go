...
func TestDockerCreateResolvesImageFromRuntime(t *testing.T) {
	cases := []struct {
		...
		{"explicit_cimicode_bridge_uses_bridge_image", RuntimeCimiCodeBridge, "", "agentteams/cimicode-bridge-worker:latest"},
		...
		{"empty_runtime_with_cimicode_bridge_fallback_uses_bridge_image", "", RuntimeCimiCodeBridge, "agentteams/cimicode-bridge-worker:latest"},
