...
const (
	...
	RuntimeCimiCodeBridge = "cimicode-bridge"
)
...
func ValidRuntime(r string) bool {
	return r == "" || r == RuntimeOpenClaw || r == RuntimeCopaw || r == RuntimeHermes || r == RuntimeOpenHuman || r == RuntimeQwenPaw || r == RuntimeCimiCodeBridge
}
...
type CreateRequest struct {
	...
	Runtime string            `json:"runtime,omitempty"` // "openclaw" | "copaw" | "hermes" | "qwenpaw" | "cimicode-bridge"
