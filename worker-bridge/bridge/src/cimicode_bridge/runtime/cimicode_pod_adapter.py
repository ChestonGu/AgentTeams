...
class CimicodePodAdapter:
    ...
    async def chat(
        ...
        *,
        ...
        sandbox 绑定由 base_url 本身承载（单 pod 无独立沙箱）。extra_params
        是 stateless 平台的追加键透传袋——pod 形态无对应通道，收下忽略
        （TurnRunner 统一传参，两种 adapter 签名同构）。
        ...
        """
        del history, sandbox_id, extra_params
