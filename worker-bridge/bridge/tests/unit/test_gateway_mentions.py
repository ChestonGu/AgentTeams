...
ROOM = "!room-1:x"
LEAD = "@oct-lead:agentteams-oct-synapse.agentteams-test.svc.cluster.local"
OCW = "@ocw-1:agentteams-oct-synapse.agentteams-test.svc.cluster.local"
ADMIN = "@admin:agentteams-oct-synapse.agentteams-test.svc.cluster.local"
