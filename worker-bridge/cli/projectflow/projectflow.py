#!/usr/bin/env python3
"""projectflow CLI — the worker-bridge leader's project/task protocol commands.

worker-bridge migration / leader side (prepares a future migration of
the Leader runtime to worker-bridge; the copaw Leader stays authoritative
...
meta.json/spec.md/result.md), so a mixed copaw-leader + worker-bridge-worker
team — or later a worker-bridge leader + copaw workers — stays
byte-compatible:
