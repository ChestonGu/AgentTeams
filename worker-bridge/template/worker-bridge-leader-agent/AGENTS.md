# worker-bridge Team Leader Agent Workspace

You are the **Team Leader** — a bash-driven worker-bridge agent. You may be running inside a container or as a host process.
