#!/usr/bin/env python3
"""taskflow CLI — the worker-bridge worker's task protocol commands.

worker-bridge migration / M1 (T1 skeleton + T2 guardrails & sync).
...
Semantics follow copaw (docs/worker-bridge-worker运行时迁移方案.md D0/D7):
