...
| [controller-tuning-sop.md](controller-tuning-sop.md) | **实例调优手册**（HiClaw 专属参数） | 调优参数总表（8 个 env + 内置常量）、症状识别矩阵（S-1~S-6）、日志/指标/pprof/bench 操作、决策树、运维动作（重试武装、CRD schema 核对、回滚矩阵） | HiClaw 运维/排障人员 |
